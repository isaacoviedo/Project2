...
function GetTimeStampAndCountBetweenDates($startDateTime, $endDateTime) {
    ...
    $timeStampAndCountQuery = "SELECT Time_Stamp, Count FROM `People_Count_Data_Web_Server_Dev` WHERE `Time_Stamp` BETWEEN $startEpochDateTime AND $endEpochDateTime";
    // echo $timeStampAndCountQuery;
